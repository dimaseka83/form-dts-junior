         ...
         <div x-show.transition="step != 'complete'">	
             ...
             <div class="border-b-2 py-4">
                 ...
                 <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                     <div class="flex-1">
                         <div x-show="step === 1">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Profil Anda</div>
                         </div>
                         
                         <div x-show="step === 2">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Alamat Anda</div>
                         </div>

                         <div x-show="step === 3">
                             <div class="text-lg font-bold text-gray-700 leading-tight">Orang Tua Anda</div>
                         </div>
                     </div>
             ...
             <div class="py-10">	
                 <div x-show.transition.in="step === 1">
                     <div class="mb-5 text-center">
                         ...
                         <div class="mx-auto w-48 text-gray-500 text-xs text-center mt-1">Klik untuk mengunggah foto</div>
                     ...
                     <div class="mb-5">
                         <ul class="grid w-full gap-6 md:grid-cols-2">
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nama Lengkap</label>
                                <input type="text"
                                    name="name"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Jenis Kelamin</label>
                                <div class="flex">
                                    <label
                                        class="flex justify-start items-center text-truncate rounded-lg bg-white pl-4 pr-6 py-3 shadow-sm mr-4">
                                        <div class="text-teal-600 mr-3">
                                            <input type="radio" value="laki-laki" class="form-radio focus:outline-none focus:shadow-outline" name="gender"/>
                                        </div>
                                        <div class="select-none text-gray-700">Laki - laki</div>
                                    </label>

                                    <label
                                        class="flex justify-start items-center text-truncate rounded-lg bg-white pl-4 pr-6 py-3 shadow-sm">
                                        <div class="text-teal-600 mr-3">
                                            <input type="radio" value="perempuan" class="form-radio focus:outline-none focus:shadow-outline" name="gender"/>
                                        </div>
                                        <div class="select-none text-gray-700">Perempuan</div>
                                    </label>
                                </div>
                            </li>
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Tempat Lahir</label>
                                <input type="text"
                                    name="tempat_lahir"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Tanggal Lahir</label>
                                <input type="date"
                                    name="tanggal_lahir"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Agama</label>
                                <select
                                    name="agama"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium">
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Telepon</label>
                                <input type="number"
                                    name="telepon"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                 ...
                 <div class="mb-5">
                         <ul class="grid w-full gap-6 md:grid-cols-2" >
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Provinsi</label>
                                <input type="text"
                                    name="provinsi"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Kabupaten/Kota</label>
                                <input type="text"
                                    name="kabupaten_kota"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Kecamatan</label>
                                <input type="text"
                                    name="kecamatan"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Kelurahan/Desa</label>
                                <input type="text"
                                    name="kelurahan_desa"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Alamat</label>
                                <textarea
                                    name="alamat"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Kode Pos</label>
                                <input type="number"
                                    name="kode_pos"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                 ...
                 <div x-show.transition.in="step === 3">
                     <div class="mb-5">
                        <ul class="grid w-full gap-6 md:grid-cols-2" >
                        <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nama Ayah</label>
                                <input type="text"
                                    name="nama_ayah"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nama Ibu</label>
                                <input type="text"
                                    name="nama_ibu"
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Pekerjaan Ayah</label>
                                <select
                                    name="pekerjaan_ayah"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium">
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Pekerjaan Ibu</label>
                                <select
                                    name="pekerjaan_ibu"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium">
                                    <option value="pns">PNS</option>
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Pendidikan Ayah</label>
                                <select
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Pendidikan Ibu</label>
                                <select
                                    name="pendidikan_ibu"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium">
                                    <option value="sd">SD</option>
                            ...
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Penghasilan Ayah</label>
                                <select
                                    name="penghasilan_ayah"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium">
                                    <option value="kurangdari1jt">Kurang dari 1jt</option>
                                    <option value="1jt-3jt">1jt - 3jt</option>
                                    <option value="3jt-5jt">3jt - 5jt</option>
                                    <option value="5jt-10jt">5jt - 10jt</option>
                                    <option value="lebihdari10jt">Lebih dari 10jt</option>
                                </select>
                            </li>
                            <li>
                                <label for="firstname" class="font-bold mb-1 text-gray-700 block">Penghasilan Ibu</label>
                                <select
